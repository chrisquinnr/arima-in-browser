# In-browser SARIMA prototype

Demonstrating the use of the `arima` package in-browser, hopefully useful as an aide when working with ARIMA predictions.




# Source Docs
https://github.com/rafat/ctsa/wiki/SARIMAX/
